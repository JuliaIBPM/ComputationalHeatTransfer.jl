...
function PointForce(u::GridData,x0::Vector{Float64},f0,t0,σt,sys::HeatConduction)
...
PointForce(u::GridData,x0::Tuple{Float64,Float64},f0,t0,σt,sys::HeatConduction) =
